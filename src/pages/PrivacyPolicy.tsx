...
export default function PrivacyPolicy() {
  ...
  return (
    <>
      <Seo
        title={lang === 'en' ? 'Privacy Policy' : 'Ø³ÙŠØ§Ø³Ø© Ø§Ù„Ø®ØµÙˆØµÙŠØ©'}
        description={
          lang === 'en'
            ? 'PhysioHub privacy policy for calculators, educational content, cookies, and advertising consent.'
            : 'Ø³ÙŠØ§Ø³Ø© Ø®ØµÙˆØµÙŠØ© PhysioHub Ø§Ù„Ø®Ø§ØµØ© Ø¨Ø§Ù„Ø­Ø§Ø³Ø¨Ø§Øª ÙˆØ§Ù„ÙƒÙˆÙƒÙŠØ² ÙˆØ§Ù„Ù…ÙˆØ§ÙÙ‚Ø© Ø§Ù„Ø¥Ø¹Ù„Ø§Ù†ÙŠØ©.'
        }
        canonicalPath="/privacy"
      />
      <PageLayout title={lang === 'en' ? 'Privacy Policy' : 'Ø³ÙŠØ§Ø³Ø© Ø§Ù„Ø®ØµÙˆØµÙŠØ©'}>
        {lang === 'en' ? (
          <>
            <p>
          ...
          <>
            <p>
              يلتزم PhysioHub بحماية خصوصيتك. توضح هذه السياسة ما قد يتم
              التعامل معه من بيانات داخل الموقع وكيفية إدارة الموافقة على
              التقنيات الاختيارية مثل كوكيز الإعلانات.
            </p>

            <h2>مدخلات الحاسبات</h2>
            <p>
              تتم معالجة معظم مدخلات الحاسبات محليًا داخل متصفحك حتى يتمكن
              الموقع من عرض التقديرات والمخرجات التعليمية. نحن لا نتعمد طلب
              سجلات طبية خاصة من المستخدمين عبر الحاسبات العامة.
            </p>
            ...
            <p>
              ...
              رفضت الموافقة الاختيارية فستظل ميزات الإعلانات غير الضرورية
              معطلة على هذا الجهاز.
            </p>

            <h2>التحليلات</h2>
            <p>
              قد يستخدم PhysioHub أدوات قياس تراعي الخصوصية لفهم الزيارات بشكل
              مجمع وتحسين المنصة. الهدف من أي تحليلات هو مراجعة الأداء العام
              وليس التعرف الشخصي على المستخدمين.
            </p>
