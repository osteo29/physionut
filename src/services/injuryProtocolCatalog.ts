...
const generatedProtocolSeeds: ProtocolSeed[] = [
  ...
  {id: 'total_knee_arthroplasty', name: 'Total knee arthroplasty', category: 'Post-surgery', bodyRegion: 'Knee', flavor: 'postsurgery'},
  {id: 'quadriceps_tendinopathy', name: 'Quadriceps tendinopathy', category: 'Tendon', bodyRegion: 'Knee', flavor: 'tendon'},
  {id: 'bakers_cyst', name: 'Baker\'s cyst', category: 'Joint', bodyRegion: 'Knee', flavor: 'joint'},
  {id: 'tibial_plateau_fracture_rehab', name: 'Tibial plateau fracture rehab', category: 'Post-surgery', bodyRegion: 'Knee', flavor: 'postsurgery'},
  {id: 'meniscectomy_rehab', name: 'Meniscectomy rehab', category: 'Post-surgery', bodyRegion: 'Knee', flavor: 'postsurgery'},
  {id: 'spondylolisthesis', name: 'Spondylolisthesis', category: 'Overuse', bodyRegion: 'Back', flavor: 'overuse'},
  {id: 'post_laminectomy_rehab', name: 'Post-laminectomy rehabilitation', category: 'Post-surgery', bodyRegion: 'Back', flavor: 'postsurgery'},
  {id: 'total_hip_arthroplasty', name: 'Total hip arthroplasty', category: 'Post-surgery', bodyRegion: 'Hip', flavor: 'postsurgery'},
  {id: 'snapping_hip_syndrome', name: 'Snapping hip syndrome', category: 'Joint', bodyRegion: 'Hip', flavor: 'joint'},
  {id: 'radial_tunnel_syndrome', name: 'Radial tunnel syndrome', category: 'Overuse', bodyRegion: 'Elbow', flavor: 'overuse'},
  {id: 'trigger_finger', name: 'Trigger finger', category: 'Overuse', bodyRegion: 'Hand', flavor: 'overuse'},
  {id: 'mallet_finger', name: 'Mallet finger', category: 'Bone', bodyRegion: 'Hand', flavor: 'bone'},
  {id: 'boutonniere_deformity', name: 'Boutonniere deformity', category: 'Overuse', bodyRegion: 'Hand', flavor: 'overuse'},
  {id: 'flexor_tendon_repair_zone_ii', name: 'Flexor tendon repair (Zone II)', category: 'Post-surgery', bodyRegion: 'Hand', flavor: 'postsurgery'},
  {id: 'extensor_tendon_repair', name: 'Extensor tendon repair', category: 'Post-surgery', bodyRegion: 'Hand', flavor: 'postsurgery'},
  {id: 'dupuytrens_contracture', name: 'Dupuytren\'s contracture', category: 'Overuse', bodyRegion: 'Hand', flavor: 'overuse'},
  {id: 'distal_biceps_rupture_rehab', name: 'Distal biceps rupture rehab', category: 'Post-surgery', bodyRegion: 'Elbow', flavor: 'postsurgery'},
  {id: 'triceps_tendinopathy', name: 'Triceps tendinopathy', category: 'Tendon', bodyRegion: 'Elbow', flavor: 'tendon'},
  {id: 'little_leaguers_shoulder', name: 'Little Leaguer\'s shoulder', category: 'Pediatric', bodyRegion: 'Shoulder', flavor: 'pediatric'},
  {id: 'sinding_larsen_johansson', name: 'Sinding-Larsen-Johansson syndrome', category: 'Pediatric', bodyRegion: 'Knee', flavor: 'pediatric'},
  {id: 'perthes_disease', name: 'Perthes disease', category: 'Pediatric', bodyRegion: 'Hip', flavor: 'pediatric'},
  {id: 'peroneal_nerve_palsy', name: 'Peroneal nerve palsy', category: 'Overuse', bodyRegion: 'Knee', flavor: 'overuse'},
  {id: 'crps_type_i', name: 'Complex regional pain syndrome (Type I)', category: 'Overuse', bodyRegion: 'Whole body', flavor: 'overuse'},
  {id: 'brachial_plexus_neuropraxia', name: 'Brachial plexus neuropraxia', category: 'Overuse', bodyRegion: 'Shoulder', flavor: 'overuse'},
  {id: 'thoracic_hyperkyphosis', name: 'Thoracic hyperkyphosis', category: 'Overuse', bodyRegion: 'Spine', flavor: 'overuse'},
  {id: 'thoracic_outlet_syndrome', name: 'Thoracic outlet syndrome', category: 'Overuse', bodyRegion: 'Shoulder', flavor: 'overuse'},
  {id: 'lumbar_facet_joint_dysfunction', name: 'Lumbar facet joint dysfunction', category: 'Overuse', bodyRegion: 'Back', flavor: 'overuse'},
  {id: 'sacroiliac_joint_dysfunction', name: 'Sacroiliac joint dysfunction', category: 'Overuse', bodyRegion: 'Hip', flavor: 'overuse'},
  {id: 'cervical_facet_joint_pain', name: 'Cervical facet joint pain', category: 'Overuse', bodyRegion: 'Neck', flavor: 'overuse'},
  {id: 'scheuermanns_kyphosis', name: 'Scheuermann\'s kyphosis', category: 'Pediatric', bodyRegion: 'Spine', flavor: 'pediatric'},
  {id: 'thoracic_disc_herniation', name: 'Thoracic disc herniation', category: 'Overuse', bodyRegion: 'Spine', flavor: 'overuse'},
  {id: 'peroneal_tendinopathy', name: 'Peroneal tendinopathy', category: 'Tendon', bodyRegion: 'Ankle', flavor: 'tendon'},
  {id: 'posterior_tibial_tendon_dysfunction', name: 'Posterior tibial tendon dysfunction', category: 'Tendon', bodyRegion: 'Ankle', flavor: 'tendon'},
  {id: 'sinus_tarsi_syndrome', name: 'Sinus tarsi syndrome', category: 'Joint', bodyRegion: 'Ankle', flavor: 'joint'},
  {id: 'jones_fracture_rehab', name: 'Jones fracture rehab', category: 'Post-surgery', bodyRegion: 'Foot', flavor: 'postsurgery'},
  {id: 'ankle_fracture_orif_rehab', name: 'Ankle fracture ORIF rehab', category: 'Post-surgery', bodyRegion: 'Ankle', flavor: 'postsurgery'},
  {id: 'hallux_valgus_rehab', name: 'Hallux valgus rehab', category: 'Post-surgery', bodyRegion: 'Foot', flavor: 'postsurgery'},
  {id: 'tibialis_anterior_tendinopathy', name: 'Tibialis anterior tendinopathy', category: 'Tendon', bodyRegion: 'Ankle', flavor: 'tendon'},
];
