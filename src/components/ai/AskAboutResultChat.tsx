      ...
      ? [
          {
            ...
            prompt:
              lang === 'en'
                ...
                : 'كيف يمكنني تحسين هذه النتيجة بشكل آمن؟',
          },
          {
            label: lang === 'en' ? 'Risk factors?' : 'عوامل الخطر؟',
            prompt:
              lang === 'en'
                ? 'What are common risk factors related to this result?'
                : 'ما هي عوامل الخطر الشائعة المرتبطة بهذه النتيجة؟',
          },
          {
            label: lang === 'en' ? 'Next steps' : 'الخطوات التالية',
            prompt:
              lang === 'en'
                ? 'What are practical next steps for me?'
                : 'ما هي الخطوات العملية التالية التي تنصح بها؟',
          },
        ]
        ...
        ? [
            {
              ...
              prompt:
                lang === 'en'
                  ? 'Suggest meal ideas that match my macros.'
                  : 'اقترح أفكار وجبات تناسب الماكروز الخاصة بي.',
            },
            {
              label: lang === 'en' ? 'Adjust for training' : 'تعديل للتدريب',
              prompt:
                lang === 'en'
                  ? 'How should I adjust carbs/protein on training vs rest days?'
                  : 'كيف أعدّل الكارب والبروتين في أيام التمرين مقارنة بأيام الراحة؟',
            },
          ]
          ...
          ? [
              {
                ...
                prompt:
                  lang === 'en'
                    ? 'Based on this, what is a safe calorie target for fat loss?'
                    : 'بناءً على ذلك، ما هو هدف سعرات آمن لنزول الدهون؟',
              },
              {
                label: lang === 'en' ? 'Maintenance' : 'ثبات الوزن',
                prompt:
                  lang === 'en'
                    ? 'How do I maintain my weight with this estimate?'
                    : 'كيف أحافظ على وزني بناءً على هذا التقدير؟',
              },
            ]
          : [
              {
                ...
                prompt:
                  lang === 'en'
                    ...
                    : 'اشرح هذه النتيجة بطريقة مبسطة.',
              },
              {
                label: lang === 'en' ? 'Safety notes' : 'ملاحظات أمان',
                prompt:
                  lang === 'en'
                    ? 'Any safety considerations or when to consult a clinician?'
                    : 'هل توجد اعتبارات أمان أو متى أراجع مختصًا؟',
              },
            ];
